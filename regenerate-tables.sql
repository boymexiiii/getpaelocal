-- =====================================================
-- COMPREHENSIVE DATABASE TABLE REGENERATION SCRIPT
-- This script recreates all tables that were lost
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_otps_type ON public.otps(type);
...
DO $$
BEGIN
    RAISE NOTICE '✅ All tables have been successfully regenerated!';
    RAISE NOTICE '📋 Tables created: profiles, wallets, transactions, investments, notifications, otps, bank_accounts, virtual_cards, gift_cards, admin_actions, admin_alerts, webhook_logs';
